      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold">Packet Sniffer</h1>
              <p className="text-slate-600 dark:text-slate-400">Real-time network traffic analysis and monitoring</p>
            </div>
        ...
        <Card className="max-w-4xl mx-auto">
          <CardHeader className="text-center">
            ...
            <CardDescription className="text-lg">
              Professional network traffic analysis and packet inspection tool
            </CardDescription>
          </CardHeader>
